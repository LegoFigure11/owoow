...
public static class Encounters
{
    ...
    private static readonly Dictionary<string, AvailableWeather> WeathersByArea = new()
    {
        ...
        { "Insular Sea", AvailableWeather.Normal | AvailableWeather.Overcast | AvailableWeather.Stormy | AvailableWeather.Intense_Sun | AvailableWeather.Heavy_Fog },
        { "Insular Sea (Sharpedo)", AvailableWeather.Normal | AvailableWeather.Overcast | AvailableWeather.Stormy | AvailableWeather.Intense_Sun | AvailableWeather.Heavy_Fog },
        { "Insular Sea (Surfing)", AvailableWeather.Normal | AvailableWeather.Overcast | AvailableWeather.Stormy | AvailableWeather.Intense_Sun | AvailableWeather.Heavy_Fog },
    ...
    public static readonly IReadOnlyDictionary<ulong, string> Zones = new Dictionary<ulong, string>
    {
        ...
        { 0x7E87BC6C177B403F, "Wyndon Stadium (Locker Room)" },
        { 0x7E87BB6C177B3E8C, "Wyndon Stadium (Locker Room)" },
        { 0x7E84B86C1779039C, "Wyndon Stadium (Pitch)" },
        { 0x7E8ECA6C178176B7, "Wyndon Stadium (Pitch)" },
