...
public static class Util
{
    ...
    {
        return jump < uint.MaxValue ? XoroshiroTableJump(s0, s1, (uint)jump) : XoroshiroLongJump(s0, s1, jump);
    }
    ...
    private static (ulong s0, ulong s1) XoroshiroLongJump(ulong _s0, ulong _s1, ulong jump)
    {
        ulong s0 = 0;
        ulong s1 = 0;
    ...
    public static BigInteger BitBase2PowModGF2(ulong power, BigInteger modulus)
    {
    ...
    public static BigInteger CalcJumpPolynomial(BigInteger characteristic, ulong jumpCount)
    {
