namespace owoow.WinForms
{
    partial class MainWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            CB_DexRec4 = new ComboBox();
            CB_DexRec3 = new ComboBox();
            ...
            L_RainTick = new Label();
            NUD_RainTick = new NumericUpDown();
            ...
            CB_Filter_Mark.Items.AddRange(new object[] { "Ignore", "None", "Any Mark", "Any Personality", "Personality/Rare", "Any (No Uncommon)", "Uncommon", "Time", "Weather", "Fishing", "Rare", "Rowdy", "Absent-Minded", "Jittery", "Excited", "Charismatic", "Calmness", "Intense", "Zoned-Out", "Joyful", "Angry", "Smiley", "Teary", "Upbeat", "Peeved", "Intellectual", "Ferocious", "Crafty", "Scowling", "Kindly", "Flustered", "Pumped-Up", "Zero Energy", "Prideful", "Unsure", "Humble", "Thorny", "Vigor", "Slump" });
            ...
            // P_EncounterSettings
            // 
            P_EncounterSettings.Controls.Add(GB_DexRec);
            P_EncounterSettings.Controls.Add(GB_Advanced);
            P_EncounterSettings.Location = new Point(482, 9);
            P_EncounterSettings.Name = "P_EncounterSettings";
            P_EncounterSettings.Size = new Size(212, 308);
            P_EncounterSettings.TabIndex = 28;
            // 
            // GB_DexRec
            // 
            GB_DexRec.Controls.Add(B_RefreshDexRec);
            GB_DexRec.Controls.Add(CB_DexRec4);
            ...
            GB_Advanced.Controls.Add(L_RainTick);
            GB_Advanced.Controls.Add(NUD_RainTick);
            ...
            // TC_EncounterType
            // 
            TC_EncounterType.Controls.Add(TP_Static);
            ...
            GB_Connection.Location = new Point(0, 49);
