namespace owoow.Core.Interfaces
{
    ...
    public class SkillBroFrame : IBasicFrame, IRetailFrame
    {
        ...
        public byte GoldBottleCap   { get; set; } = 0;
        public byte BottleCap       { get; set; } = 0;
        public byte NormalGem       { get; set; } = 0;
        public byte StickyBarb      { get; set; } = 0;
        public byte LightClay       { get; set; } = 0;
        public byte LaggingTail     { get; set; } = 0;
        public byte IronBall        { get; set; } = 0;
        public byte MetalCoat       { get; set; } = 0;
        public byte IceStone        { get; set; } = 0;
        public byte DawnStone       { get; set; } = 0;
        public byte DuskStone       { get; set; } = 0;
        public byte ShinyStone      { get; set; } = 0;
        public byte MoonStone       { get; set; } = 0;
        public byte SunStone        { get; set; } = 0;
        public byte FossilizedFish  { get; set; } = 0;
        public byte FossilizedDrake { get; set; } = 0;
        public byte FossilizedDino  { get; set; } = 0;
        public byte FossilizedBird  { get; set; } = 0;
        public byte WishingPiece    { get; set; } = 0;
        public byte CometShard      { get; set; } = 0;
        public byte RareBone        { get; set; } = 0;
